...
<t:layout>
	<div class="row">
		<div class="col-5 mx-auto">
			<h3 class="mb-3 text-center">Creare editie</h3>
			
			<c:set var="createEditionAction"><c:url value='/createEdition/submit' /></c:set>
			<form:form method="POST" action="${createEditionAction}" modelAttribute="edition">
